...
export const mockOrders: Order[] = [
  {
    ...
    originalFileNames: ["History_Essay_Final.pdf"],
  ...
  },
  {
    ...
    originalFileNames: ["Lab_Report_Chemistry.docx"],
    orderType: "practical",
    originalFileUrls: ["#"],
    pageCount: 3,
    status: "in_progress",
  ...
  },
  {
    ...
    originalFileNames: ["presentation_slides.jpg"],
    orderType: "assignment",
    originalFileUrls: ["#"],
    pageCount: 1,
    status: "pending",
  ...
  },
  {
    ...
    originalFileNames: ['Calculus_Homework_Set3.pdf'],
    orderType: 'assignment',
    originalFileUrls: ['#'],
    pageCount: 12,
    status: 'pending',
